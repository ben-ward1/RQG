...
namespace RQG.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Description,Answer")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Description,Category,Answer")] Question question)
        {
            if (id != question.ID)
            {
                return NotFound();
